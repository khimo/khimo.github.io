...
This configuration can be the same for cameras of the same brand/model, click [here](../camera_configs) to access a list of configurations of other users and help expanding it by adding yours!
