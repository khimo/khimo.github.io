...
Per default, _admin_ password is unknown but it can be set to "_admin_" by activating the Setup button function No.2 ([See button functions](https://sofiboselli.github.io/bli-guides/bli_advanced_user_guide/05-user_button)). This 
...
This configuration can be the same for cameras of the same brand/model, click [here](https://sofiboselli.github.io/bli-guides/camera_configs.md) to access a list of configurations of other users and help expanding it by adding yours!
