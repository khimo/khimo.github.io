...
*You will also be able to configure shortcuts to trigger [Macros](https://khimo.github.io/bli-guides/bli-pro-user-guide.html#macros) by pressing only a couple of buttons.*
...
1. Go to Macros and [create a Macro](https://khimo.github.io/bli-guides/bli-pro-user-guide.html#macros) whos commands turn on all lights
